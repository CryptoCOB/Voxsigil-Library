...
def move_files_by_pattern():
    ...
    file_moves = {
        ...
        "archive/old_status_reports": [
            "*COMPLETE*.md", "*COMPLETE*.py", "*COMPLETION*.md", "*COMPLETION*.py",
            "*RESOLVED*.md", "*REPORT*.md", "*STATUS*.md", "*SUCCESS*.md",
            "*FINAL*.md", "*DEPLOYMENT*.md", "*VALIDATION*.md"
        ],
        
        # Test files
        "dev/test_scripts": [
            "test_*.py", "*test*.py", "*Test*.py", "check_*.py", "verify_*.py",
            "validate_*.py", "quick_test*.py", "*minimal*test*.py"
        ],
        
        # Demo files
        "dev/demos": [
            "demo_*.py", "*demo*.py", "simple_*.py"
        ],
        
        # Diagnostic files
        "dev/diagnostics": [
            "*diagnostic*.py", "*diagnose*.py", "*debug*.py", "*crash*.py",
            "*hang*.py", "analyze_*.py"
        ],
        
        # Launcher files
        "scripts/launchers": [
            "launch_*.py", "Launch_*.bat", "*launcher*.py"
        ],
        
        # Documentation guides
        "documentation/guides": [
            "*GUIDE*.md", "*TECHNIQUES*.md", "README.md"
        ],
        
        # Audio samples
        "resources/audio_samples": [
            "*.wav", "*.mp3", "*.ogg", "*voice_sample*"
        ],
        ...
        "scripts/utilities": [
            "cleanup_*.py", "clean_*.py", "*syntax_check*.py"
        ],
        
        # Legacy reports
        "archive/legacy_files": [
            "*FIXES*.py", "*ERROR*.py", "*ATTRIBUTE*.py", "*ENCODING*.py",
            "*CIRCULAR*.py", "*EVENT_LOOP*.py"
        ]
    }
