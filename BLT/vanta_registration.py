...
async def register_blt_rag_interface(module_registry, config: Dict[str, Any]):
    ...
    try:
        from BLT.blt_supervisor_integration import COMPONENTS_AVAILABLE, BLTSupervisorRagInterface
    ...
    try:
        ...
        try:
            ...
            router_mapping = {
                ...
                if hasattr(EntropyRouter, "calculate_entropy")
                else None,
            }
            ...
            encoder_mapping = {
                ...
                if hasattr(ByteLatentTransformerEncoder, "calculate_similarity")
                else None,
            }
...
async def register_tinyllama_integration(module_registry, config: Dict[str, Any]):
    ...
    try:
        from BLT.blt_supervisor_integration import COMPONENTS_AVAILABLE, TinyLlamaIntegration
