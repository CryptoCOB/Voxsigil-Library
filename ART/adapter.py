...
class VANTAFactory(BaseAgent):
    ...
    def _generate_cognitive_trace(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'cognitive_state': {
                'integration_efficiency': self.cognitive_metrics['conversion_successes'] / max(1, self.cognitive_metrics['integration_events']),
                'factory_utilization': min(self.cognitive_metrics['supervisor_creations'] / 10.0, 1.0),
                'optimization_ratio': self.cognitive_metrics['optimization_cycles'] / max(1, self.cognitive_metrics['integration_events'])
            }
        }
