...
class VMBFinalDemoTab(QWidget):
    """PyQt5-based VMB Final Demo Interface as a Tab (converted from QMainWindow)"""
...
# Keep the original QMainWindow class for backward compatibility but mark as deprecated
class VMBFinalDemo(QMainWindow):
    """PyQt5-based VMB Final Demo Interface - DEPRECATED: Use VMBFinalDemoTab instead"""
    ...
    def _init_ui(self):
        """Initialize the user interface"""
        self.setWindowTitle("VMB Final Demo (PyQt5) - DEPRECATED")
        ...
        # Warning label
        warning = QLabel(
            "⚠️ DEPRECATED: This standalone window is deprecated. Use VMBFinalDemoTab in the unified GUI."
        )
