"""
VoxSigil Enhancement Pipeline v3 - Streaming, Memory-Efficient

- Processes files one at atime
- Minimal memory footprint
- Handles all categories
- Fast direct YAML rewrite
- No Ollama dependency
- Skips problematic files gracefully

Usage:
  python voxsigil_enhance_pipeline_v3.py
"""
...
def enhance_one_file(in_path: Path) -> bool:
    ...
    try:
        ...
        try:
            text = in_path.read_text(encoding="latin-1", errors="ignore")
        except (OSError, UnicodeDecodeError, TimeoutError):
            return False
